package store_stock_movement_mgmt.recieve.model.master;
...
public class StoreRecieveMaster implements Serializable {
	...
	public Timestamp getRecievedOn() {
		return recievedOn;
	}

	public void setRecievedOn(Timestamp recievedOn) {
	...
	public StoreRecieveMaster(Long storeMovementSeqNo, Timestamp recievedOn, Timestamp appliedOn, Long assetSeqNo,
			Float consignQty, Timestamp consignedOn, Character doneflag, Long locationSeqNo, Character okflag,
			Timestamp processedOn, Long qtyUnitSeqNo, Float qualityQty, Float recievedQty, Long resourceSeqNo,
