package store_stock_movement_mgmt.issue.model.master;
...
/**
 * The persistent class for the STORE_ISSUE_MASTER database table.
 * 
 */
@Entity
...
public class StoreIssueMaster implements Serializable 
{
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StoreIssueMaster other = (StoreIssueMaster) obj;
		if (assetSeqNo == null) {
	...
	public StoreIssueMaster(Long storeMovementSeqNo, Timestamp appliedOn, Long assetSeqNo, Float consignQty,
			Character doneflag, Long locationSeqNo, Character okflag, Timestamp processedOn, Float processedQty,
			Long qtyUnitSeqNo, Float qualityQty, Timestamp requestOn, Float requestQty, Long resourceSeqNo,
