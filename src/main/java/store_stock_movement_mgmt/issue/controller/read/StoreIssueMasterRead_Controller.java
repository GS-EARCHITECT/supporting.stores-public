package store_stock_movement_mgmt.issue.controller.read;
...
import store_stock_movement_mgmt.issue.services.read.I_StoreIssueMasterRead_Service;
...
public class StoreIssueMasterRead_Controller 
{
	...
	public ResponseEntity<Float> getQCQtyForLineItem(@PathVariable Long mid)
	{
		...
		Float result = null;
		try {
			qty = storeIssueMasterReadService.getQCQtyForLineItem(mid);
			result = qty.get();
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
