package store_order_inwards_mgmt.model.repo.read;
...
@Repository("storeOrderInwardsRepo")
public interface StoreOrderInward_Repo extends JpaRepository<StoreOrderInward, Long> 
{
...
Float getOrderInwardsAllocatedQty(@Param("storeReqSeqNo") Long storeReqSeqNo);
...
Float getOrderInwardsRequestQty(@Param("storeReqSeqNo") Long storeReqSeqNo);
...
Float getOrderInwardsBookedQty(@Param("storeReqSeqNo") Long storeReqSeqNo);
...
Float getOrderInwardsMovedQty(@Param("storeReqSeqNo") Long storeReqSeqNo);
...
CopyOnWriteArrayList<StoreOrderInward> getAllOrderInwards();
