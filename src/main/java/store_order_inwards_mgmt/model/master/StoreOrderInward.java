package store_order_inwards_mgmt.model.master;
...
/**
 * The persistent class for the STORE_ORDER_INWARDS database table.
 * 
 */
@Entity
...
public class StoreOrderInward implements Serializable {
	...
	public StoreOrderInward(Long storeRequestSeqNo, Character doneflag, Character isBooked, Long itemSeqNo,
