...
public interface I_StoreOrderResourceOutwardsReadPublic_Service
{
	...
	public CompletableFuture<CopyOnWriteArrayList<StoreOrderResourceOutward_DTO>> getAllRowsForMode( Short mode);
	...
	public CompletableFuture<Float> getTotalQtyMovedForResourceForJob( Long jobWorkSeqNo,  Long resourceSeqNo, Short mode);
