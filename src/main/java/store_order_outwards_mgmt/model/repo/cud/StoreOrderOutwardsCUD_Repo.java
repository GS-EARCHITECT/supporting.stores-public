package store_order_outwards_mgmt.model.repo.cud;
...
@Repository("storeOrderOutwardsCUDRepo")
public interface StoreOrderOutwardsCUD_Repo extends JpaRepository<StoreOrderOutward, Long> 
{
