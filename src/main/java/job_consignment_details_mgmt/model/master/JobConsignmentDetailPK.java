 ...
 */
@Embeddable
public class JobConsignmentDetailPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof JobConsignmentDetailPK)) {
			return false;
		}
		JobConsignmentDetailPK castOther = (JobConsignmentDetailPK) other;
	...
	public JobConsignmentDetailPK(Long resourceSeqNo, Long consignmentSeqNo, Long assetSeqNo) {
		super();
		this.resourceSeqNo = resourceSeqNo;
		this.consignmentSeqNo = consignmentSeqNo;
		this.assetSeqNo = assetSeqNo;
